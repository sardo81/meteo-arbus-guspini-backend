...
api = FastAPI(title="Meteo Arbus-Guspini API", version="11.0-rain-events-hail-corrections")
api.add_middleware(
    CORSMiddleware,
    allow_origins=["*"],
...
def parse_observation(obs: Dict[str, Any]) -> Dict[str, Any]:
    ...
    return {
        ...
        "parser_version": "10.0-rain-events",
        "status": "feed_read",
...
def root() -> Dict[str, str]:
    return {
        ...
        "parser": "Weather Underground background feed v11 con eventi pioggia automatici e correzione grandine",
        "endpoint": "/stations",
    }
